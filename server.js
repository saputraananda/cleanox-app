...
import posAgendaRoutes from './api/web/routes/posAgenda.routes.js';
import posBundlesRoutes from './api/web/routes/posBundles.routes.js';
...
import mobileAgendaRoutes from './api/mobile/routes/mobileAgenda.routes.js';
...
app.use('/api/pos-agenda', posAgendaRoutes);
app.use('/api/pos-bundles', posBundlesRoutes);
app.use('/api/wilayah', wilayahRoutes);
app.use('/api/mobile-attendance', mobileAttendanceRoutes);
app.use('/api/mobile-tasks', mobileTasksRoutes);
app.use('/api/mobile-agenda', mobileAgendaRoutes);
...
app.use('/api/mobile-off-day', mobileOffDayRoutes);
